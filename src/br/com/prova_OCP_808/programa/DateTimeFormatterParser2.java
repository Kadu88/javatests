...
public class DateTimeFormatterParser2 {
	...
	public static void main(String []args ) {
		...
		System.out.println(localDate.format(dateFormatterSaida)+"\n"); //1986-01-22
		//System.out.println(localDate.format(timeFormatterSaida)); //RuntimeException 
		//java.time.temporal.UnsupportedTemporalTypeException: Unsupported field: HourOfDay
		//System.out.println(localDate.format(dateTimeFormatterSaida)); //RuntimeException 
		//java.time.temporal.UnsupportedTemporalTypeException: Unsupported field: HourOfDay
		
		System.out.println(localTime.format(timeFormatterSaida)+"\n"); //20:31.27
		//System.out.println(localTime.format(dateFormatterSaida)+"\n");//RuntimeException 
		//java.time.temporal.UnsupportedTemporalTypeException: Unsupported field: YearOfEra
		//System.out.println(localTime.format(dateTimeFormatterSaida)); //RuntimeException 
		//java.time.temporal.UnsupportedTemporalTypeException: Unsupported field: DayOfMonth
		
		System.out.println(localDateTimeParsed.format(dateFormatterSaida)); //2012-01-02
		System.out.println(localDateTimeParsed.format(timeFormatterSaida)); //21:34.48
		System.out.println(localDateTimeParsed.format(dateTimeFormatterSaida)); //02-01-2012 21:34.48
	}
}